...
console.log(netflix.season1.seasonInfo.episodeInfo[4].episode);
console.log(netflix.season1.seasonInfo.episodeInfo[4].episodeName);

//a function is below that prints episode name from object based on index you give it during function call
...
let spaceJam = {
  ...
  //Object gives you the interface for looking at objects; .keys allows you to pull the 
  //keys of the object rather than the values
  ...
  //console.log(garden.vegetable); // 'zucchini't
